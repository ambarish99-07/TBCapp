...
const styles = StyleSheet.create({
  ...
  levelText: { fontSize: 12, color: theme.colors.text },
  levelTextActive: { color: "#fff", fontWeight: "700" },
  qtyRow: { flexDirection: "row", alignItems: "center", gap: 16 },
  qtyButton: { width: 36, height: 36, borderRadius: 18, backgroundColor: theme.colors.surface, alignItems: "center", justifyContent: "center" },
  qtyButtonText: { fontSize: 18, fontWeight: "700", color: theme.colors.text },
  qtyValue: { fontSize: 16, fontWeight: "700" },
  addButton: { backgroundColor: theme.colors.primary, borderRadius: theme.radius, padding: theme.spacing(2), alignItems: "center", marginVertical: theme.spacing(3) },
